...
namespace MyRestaurant {
    ...
    public partial class RestaurantDataSet5 : global::System.Data.DataSet {
        ...
        public partial class CategoriesDataTable : global::System.Data.TypedTableBase<CategoriesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CategoriesRow AddCategoriesRow(string Cname) {
        ...
        public partial class CategoriesRow : global::System.Data.DataRow {
            ...
            public string Cname {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'Cname\' in table \'Categories\' is DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsCnameNull() {
                return this.IsNull(this.tableCategories.CnameColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetCnameNull() {
                this[this.tableCategories.CnameColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace MyRestaurant.RestaurantDataSet5TableAdapters {
    ...
    public partial class CategoriesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Categories] WHERE (([Id] = @Original_Id) AND ((@IsNull_Cname =" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Categories] ([Cname]) VALUES (@Cname);\r\nSELECT Id, Cname FROM " +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Categories] SET [Cname] = @Cname WHERE (([Id] = @Original_Id) AND (" +
                "(@IsNull_Cname = 1 AND [Cname] IS NULL) OR ([Cname] = @Original_Cname)));\r\nSELEC" +
                "T Id, Cname FROM Categories WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Cname FROM dbo.Categories";
        ...
        public virtual int Fill(RestaurantDataSet5.CategoriesDataTable dataTable) {
        ...
        public virtual RestaurantDataSet5.CategoriesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            RestaurantDataSet5.CategoriesDataTable dataTable = new RestaurantDataSet5.CategoriesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(RestaurantDataSet5.CategoriesDataTable dataTable) {
        ...
        public virtual int Update(string Cname, int Original_Id, string Original_Cname, int Id) {
            if ((Cname == null)) {
        ...
        public virtual int Update(string Cname, int Original_Id, string Original_Cname) {
            return this.Update(Cname, Original_Id, Original_Cname, Original_Id);
        }
    }
